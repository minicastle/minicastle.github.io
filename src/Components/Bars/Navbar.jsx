...
const MenuListItem = styled.li`
  ...
  user-select: none;
  ${(props) => {
    return props.pageState ? { color: "#919191" } : "";
  }}
  :hover {
    scale: 1.03;
    color: #919191;
...
const MenuMinimizeOpen = styled.div`
  ...
  @media screen and (max-width: 700px) {
    ${(props) => {
      return props.minimize ? { display: "flex" } : "";
    }}
  }
`;
/** 메뉴 최소화 모뎀 닫기*/
  ...
  return (
    <Container>
      ...
      <MenuList>
        ...
        >
          <MenuListItem pageState={pageData === "projects"}>
        ...
        >
          <MenuListItem pageState={pageData === "about"}>
        ...
        >
          <MenuListItem pageState={pageData === "contact"}>
