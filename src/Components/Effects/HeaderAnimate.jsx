  ...
  return (
    <Container ref={container}>
      ...
      <Observe
        className="observe"
        data-value="8"
        src="../headerAnimate/image1.png"
      />
      <Observe
        className="observe"
        data-value="10"
        src="../headerAnimate/image2.png"
      />
      <Observe
        className="observe"
        data-value="-3"
        src="../headerAnimate/image3.png"
      />
      <Observe
        className="observe"
        data-value="-6"
        src="../headerAnimate/image4.png"
      />
      <Observe
        className="observe"
        data-value="-10"
        src="../headerAnimate/image5.png"
      />
      <Observe
        className="observe"
        data-value="-9"
        src="../headerAnimate/image6.png"
      />
      <Observe
        className="observe"
        data-value="11"
        src="../headerAnimate/image7.png"
      />
      <Observe
        className="observe"
        data-value="8"
        src="../headerAnimate/image8.png"
      />
    </Container>
  );
}
