...
function Type1({ children, color = "ffffff" }) {
  return <Text1 color={color}>{children}</Text1>;
}
/** 텍스트 포멧 2  */
function Type2({ children, color = "ffffff" }) {
  return <Text2 color={color}>{children}</Text2>;
}
/** 텍스트 포멧 3  */
function Type3({ children, color = "ffffff" }) {
  return <Text3 color={color}>{children}</Text3>;
}
/** 텍스트 포멧 4  */
function Type4({ children, color = "ffffff" }) {
  return <Text4 color={color}>{children}</Text4>;
}
