      ...
      <LeftSide id="item">
        <AboutContents imageSrc="./images/sudologo.png">
          <TextContainer>
            <WobbleVertical>
              <TextBorder>
                <Type3 color="00337C">수도전기 공업고등학교</Type3>
              </TextBorder>
            </WobbleVertical>
            <Info> 정보통신 학과 : 2016년도 입학 ~ 2019년도 졸업</Info>
            <Info>
              {" "}
              수도전기 공업고등학교는 한국전력공사의 지원으로 설립되었습니다.
            </Info>
            <Info>
              {" "}
              국내 최고의 '마이스터고'라는 불리우며 많은 인재를 배출했습니다.
            </Info>
            <Info> 자신의 꿈을 키워나가는 학교라는 목적성을 가지고</Info>
            <Info>
              {" "}
              학생 모두가 현직에서의 업무능력을 키우기 위해 노력하고 있습니다.
            </Info>
          </TextContainer>
        </AboutContents>
      </LeftSide>
      <RightSide id="item">
        <AboutContents imageSrc="./images/dasonlogo.png">
          <TextContainer>
            ...
            <Info>
              {" "}
              근무중에는 SCADA 시스템을 설계하고 Client가 사용할 UI설계
            </Info>
            ...
            <Info style={{ fontSize: "15px" }}>
              {" "}
              ▹ 원격 단말 장치로부터 신호를 받아 소프트웨어로
            </Info>
            <Info style={{ fontSize: "15px" }}>
              {" "}
              ▹ 하드웨어의 데이터를 수집 및 관리 제어하는 프로그램
            </Info>
          </TextContainer>
        </AboutContents>
      </RightSide>
