...
`;
const AboutImageMinimize = styled.img`
    display: none;
    width: 200px;
    margin: 20px;
    @media screen and (max-width:430px) {
...
function AboutPage() {
    return (
        <Container>
            <a id='school'/>
            <Abouts>
                <Type3 id='school'>School</Type3>
                <Type4>수도전기 공업고등학교</Type4>
                <AboutTextContainer>
                    <AboutText color='B5D5C5'>정보통신 학과 : 2016년도 입학 ~ 2019년도 졸업</AboutText>
                ...
                <AboutImages>
                    <AboutImage loading='lazy' src='./images/sudologo.png' alt=''/>
                    <AboutImage loading='lazy' src='https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/SUDO_Electrical_Engineering_High_School_Front_View.jpg/800px-SUDO_Electrical_Engineering_High_School_Front_View.jpg' alt=''/>
                    <AboutImage loading='lazy' src='https://sudo.myapply.kr/Content/sudo/images/main_img_1.png' alt=''/>
                    <AboutImageMinimize loading='lazy' src='./images/sudologo.png' alt=''/>
                </AboutImages>
            </Abouts>
            <a id='career'/>
            <Abouts>
                <Type3 id='career'>Career</Type3>
                <Type4>다손테크</Type4>
                <AboutTextContainer>
                    <AboutText color='B5D5C5'>2019.11 입사 ~ 2020.07 퇴사</AboutText>
                    <AboutText>다손테크는 SCADA 시스템을 설계하고 Client가 사용하고 관리하는데 필요한 UI를 구성하는 회사입니다.</AboutText>
                    <AboutText>근무중에는 SCADA 시스템 설계와 Client UI개발, 서버렉 설계업무를 진행했습니다.</AboutText>
                    <AboutText>참여한 프로젝트는 평촌 IDC센터, 가산 IDC센터, 용인 세브란스 병원 프로젝트에 참여했습니다.</AboutText>
                </AboutTextContainer>
                <AboutImages>
                    <AboutImage loading='lazy' src='./images/dasonlogo.png' alt=''/>                    
                    <AboutImage loading='lazy' src='https://www.copadata.com/fileadmin/_processed_/7/1/csm_What-is-SCADA_body-2_f3d37945a3.jpg' alt=''/>
                    <AboutImageMinimize loading='lazy' src='./images/dasonlogo.png' alt=''/>
                </AboutImages>
            </Abouts>
            <a id='education'/>
            <Abouts>
                <Type3 id='education'>Education</Type3>
                ...
                <AboutImages>
                    <AboutImage loading='lazy' style={{backgroundColor:'white'}} src='https://blog.kakaocdn.net/dn/d0l1Pv/btqGmONiPmW/OluDzrKeEx79dtll0GFVik/img.png' alt=''/>
                    <AboutImageMinimize loading='lazy' style={{backgroundColor:'white'}} src='https://blog.kakaocdn.net/dn/d0l1Pv/btqGmONiPmW/OluDzrKeEx79dtll0GFVik/img.png' alt=''/>
                </AboutImages>
                <Type4>BackEnd</Type4>
                <AboutTextContainer>
